...
namespace ZhengJuyin.UI
{
    public partial class ZGraph : UserControl
    {
        ...
        ///     当前是否允许放大缩小选取框显示
        /// </summary>
        private bool _isShowBigSmallModeXY;

        /// <summary>
        ///     坐标精确度
        /// </summary>
        private readonly float _fAccuracy = 0.05f;

        /// <summary>
        ///     坐标显示最多小数位数
        /// </summary>
        private readonly int _iAccuracy = 2;
        #endregion
        ...
        /// </summary>
        private readonly List<List<float>> _listX = new List<List<float>>();

        /// <summary>
        ///     要显示的数据集合的Y轴方向值集合的引用
        ///     若显示多条数据则依次添加Y轴方向值集合的引用
        /// </summary>
        private readonly List<List<float>> _listY = new List<List<float>>();

        /// <summary>
        ///     要显示数据集合的线条颜色
        /// </summary>
        private readonly List<Color> _listColor = new List<Color>();

        /// <summary>
        ///     要显示数据集合的线条宽度
        /// </summary>
        private readonly List<int> _listWidth = new List<int>();

        /// <summary>
        ///     要显示数据集合的连接点
        /// </summary>
        private readonly List<LineJoin> _listLineJoin = new List<LineJoin>();

        /// <summary>
        ///     要显示数据集合的起始线帽
        /// </summary>
        private readonly List<LineCap> _listLineCap = new List<LineCap>();

        /// <summary>
        ///     要显示数据集合的样式
        /// </summary>
        private readonly List<DrawStyle> _listDrawStyle = new List<DrawStyle>();
        #endregion
        ...
        // X轴第一层网格线间隔
        private float _fXLinesShowFirst;
        // X轴第二层网格线间隔
        private float _fXLinesShowSecond;
        // X轴第三层网格线间隔
        private float _fXLinesShowThird;
        // Y轴第一层网格线间隔
        private float _fYLinesShowFirst;
        // Y轴第二层网格线间隔
        private float _fYLinesShowSecond;
        // Y轴第三层网格线间隔
        private float _fYLinesShowThird;
        #endregion
